...
export default function AuthModal({ isOpen, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4" aria-modal="true" role="dialog">
      ...
      {/* Card */}
      <div className="relative z-[10000] w-full max-w-sm bg-[#0f0720] border border-purple-800/40 rounded-2xl shadow-2xl shadow-purple-950/60 overflow-hidden">

        {/* Close */}
        <button
          onClick={close}
          className="absolute top-3 right-3 p-1.5 rounded-lg text-purple-400/60 hover:text-purple-300 hover:bg-purple-800/20 transition-colors"
          aria-label="Close"
        >
